...
public class RsearchApi {
    ...
    /**
     * Build call for getAdvancedMultiIndexSearchResults
     * @param search Details of the search query (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getAdvancedMultiIndexSearchResultsCall(IndexesSearchQuery search, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = search;

        // create path and map variables
        String localVarPath = "/indexes/search";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getAdvancedMultiIndexSearchResultsValidateBeforeCall(IndexesSearchQuery search, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'search' is set
        if (search == null) {
            throw new ApiException("Missing the required parameter 'search' when calling getAdvancedMultiIndexSearchResults(Async)");
        }
        

        com.squareup.okhttp.Call call = getAdvancedMultiIndexSearchResultsCall(search, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public SearchSuccess getAdvancedMultiIndexSearchResults(IndexesSearchQuery search) throws ApiException {
        ApiResponse<SearchSuccess> resp = getAdvancedMultiIndexSearchResultsWithHttpInfo(search);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<SearchSuccess> getAdvancedMultiIndexSearchResultsWithHttpInfo(IndexesSearchQuery search) throws ApiException {
        com.squareup.okhttp.Call call = getAdvancedMultiIndexSearchResultsValidateBeforeCall(search, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getAdvancedMultiIndexSearchResultsAsync(IndexesSearchQuery search, final ApiCallback<SearchSuccess> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getAdvancedMultiIndexSearchResultsValidateBeforeCall(search, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<SearchSuccess>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for getAdvancedMultiIndexSuggestResults
     * @param suggest Details of the suggest query (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getAdvancedMultiIndexSuggestResultsCall(IndexesSuggestQuery suggest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = suggest;

        // create path and map variables
        String localVarPath = "/indexes/suggest";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getAdvancedMultiIndexSuggestResultsValidateBeforeCall(IndexesSuggestQuery suggest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'suggest' is set
        if (suggest == null) {
            throw new ApiException("Missing the required parameter 'suggest' when calling getAdvancedMultiIndexSuggestResults(Async)");
        }
        

        com.squareup.okhttp.Call call = getAdvancedMultiIndexSuggestResultsCall(suggest, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public SuggestSuccess getAdvancedMultiIndexSuggestResults(IndexesSuggestQuery suggest) throws ApiException {
        ApiResponse<SuggestSuccess> resp = getAdvancedMultiIndexSuggestResultsWithHttpInfo(suggest);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<SuggestSuccess> getAdvancedMultiIndexSuggestResultsWithHttpInfo(IndexesSuggestQuery suggest) throws ApiException {
        com.squareup.okhttp.Call call = getAdvancedMultiIndexSuggestResultsValidateBeforeCall(suggest, null, null);
        Type localVarReturnType = new TypeToken<SuggestSuccess>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getAdvancedMultiIndexSuggestResultsAsync(IndexesSuggestQuery suggest, final ApiCallback<SuggestSuccess> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getAdvancedMultiIndexSuggestResultsValidateBeforeCall(suggest, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<SuggestSuccess>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    /**
     * Build call for getSimilarDocsResults
     * @param algorithm Query defintions (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getSimilarDocsResultsCall(AlgorithmSimilarDocsQuery algorithm, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = algorithm;

        // create path and map variables
        String localVarPath = "/indexes/algorithms/similardocs";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getSimilarDocsResultsValidateBeforeCall(AlgorithmSimilarDocsQuery algorithm, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'algorithm' is set
        if (algorithm == null) {
            throw new ApiException("Missing the required parameter 'algorithm' when calling getSimilarDocsResults(Async)");
        }
        

        com.squareup.okhttp.Call call = getSimilarDocsResultsCall(algorithm, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public AlgorithmSuccess getSimilarDocsResults(AlgorithmSimilarDocsQuery algorithm) throws ApiException {
        ApiResponse<AlgorithmSuccess> resp = getSimilarDocsResultsWithHttpInfo(algorithm);
        return resp.getData();
    }
     ...
     * Returns Similar Documents based on the provided document(s) details. Please ensure you refer the getting started guides, to get the format of the query right.
     * @param algorithm Query defintions (required)
     * @return ApiResponse&lt;AlgorithmSuccess&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AlgorithmSuccess> getSimilarDocsResultsWithHttpInfo(AlgorithmSimilarDocsQuery algorithm) throws ApiException {
        com.squareup.okhttp.Call call = getSimilarDocsResultsValidateBeforeCall(algorithm, null, null);
        Type localVarReturnType = new TypeToken<AlgorithmSuccess>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getSimilarDocsResultsAsync(AlgorithmSimilarDocsQuery algorithm, final ApiCallback<AlgorithmSuccess> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getSimilarDocsResultsValidateBeforeCall(algorithm, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AlgorithmSuccess>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
